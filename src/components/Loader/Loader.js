...
const LoaderComponent = () => {
    return (
        <div className="loader-container">
            <div class="mkdf-wanderland-spinner" className="loader">
                <svg
